		...
		<div className="container mx-auto p-8">
			...
			<div className="grid grid-cols-2 gap-8">
				...
				<div className="bg-zinc-800/60 border border-zinc-700/50 p-6 rounded-lg">
					<h2 className="text-lg font-semibold mb-4 text-zinc-100">❌ Old System (Database)</h2>
					<pre className="text-xs overflow-auto">{JSON.stringify(oldData, null, 2)}</pre>
				...
				{/* New System */}
				<div className="bg-zinc-800/60 border border-zinc-700/50 p-6 rounded-lg">
					<h2 className="text-lg font-semibold mb-4 text-zinc-100">✅ New System (Stripe API)</h2>
