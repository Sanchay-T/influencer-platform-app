...
export async function GET(
  ...
  try {
    ...
    structuredConsole.log('🔄 [CAMPAIGN-DETAIL-API] Querying campaign with scraping jobs and results');
    ...
    structuredConsole.log('✅ [CAMPAIGN-DETAIL-API] Campaign found:', { id: campaign.id, name: campaign.name });

    // Verificar que la campaña pertenece al usuario
    if (campaign.userId !== userId) {
      structuredConsole.error('❌ [CAMPAIGN-DETAIL-API] Unauthorized - Campaign belongs to different user', {
