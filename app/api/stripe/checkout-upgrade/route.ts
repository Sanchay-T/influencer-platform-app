	...
	try {
		...
		if (profile.stripeSubscriptionId) {
			structuredConsole.log(
				`🛒 [CHECKOUT-UPGRADE] Existing subscription detected - using checkout session for proper payment flow`,
				{
		...
		structuredConsole.log(
			`🛒 [CHECKOUT-UPGRADE] Creating checkout session - source: ${sessionSource}`
		);
