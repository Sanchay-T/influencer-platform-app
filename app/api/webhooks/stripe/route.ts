...
export async function POST(req: NextRequest) {
	...
	structuredConsole.error(
		'🚨 [DEPRECATED-WEBHOOK] Request received at /api/webhooks/stripe - this endpoint is deprecated!',
		{
	...
	return NextResponse.json(
		{
			...
			message:
				'This webhook endpoint (/api/webhooks/stripe) is deprecated. Please update your Stripe webhook configuration to use /api/stripe/webhook instead.',
			correctEndpoint: '/api/stripe/webhook',
		},
