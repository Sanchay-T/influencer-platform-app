...
import { creatorEnrichmentService, CreatorNotFoundError } from '@/lib/services/creator-enrichment';
...
export async function GET(_: Request, { params }: RouteParams) {
  ...
  try {
    ...
    logger.error('Failed to load cached enrichment', error instanceof Error ? error : new Error(String(error)), {
      creatorId,
      userId,
    });
