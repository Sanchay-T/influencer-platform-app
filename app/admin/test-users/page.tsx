		...
		<div className="max-w-6xl mx-auto p-6 space-y-6">
			...
			<Card>
				...
				<CardContent className="space-y-4">
					...
					{message && <div className="p-3 bg-gray-100 rounded text-sm font-mono">{message}</div>}
					...
					{testUser && (
						<div className="p-4 bg-blue-50 border border-blue-200 rounded space-y-2">
							...
							<div className="space-y-1 text-sm font-mono">
								<div>
									<strong>User ID:</strong> {testUser.userId}
								</div>
								<div>
							...
							<div className="flex gap-2 pt-2">
								<Button size="sm" onClick={() => setupTestLogin(testUser.userId)}>
									Setup Test Login
								</Button>
								<Button
									size="sm"
						...
						<div className="space-y-2">
							{testUsers.map((user) => (
								...
								>
									...
									<Button size="sm" variant="outline" onClick={() => setupTestLogin(user.userId)}>
										Use This User
									</Button>
								</div>
							))}
