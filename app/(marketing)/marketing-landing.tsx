						...
						<div className="space-y-8">
							...
							<div className="space-y-6">
								...
								<p className="text-xl text-white/80 max-w-lg text-pretty">
									Find creators before your competitors do. Gemz helps brands identify
									high-performing creators in real time — before anyone else does.
								</p>
							</div>
								...
								<div className="space-y-6">
									<div className="flex items-center justify-between">
										<h3 className="text-xl font-semibold text-white">
											Founders Deal — Limited to 50 Brands
										</h3>
										<ArrowRight className="h-5 w-5 text-white" />
									</div>

									<p className="text-white/80 text-sm">
										If you're scaling influencer marketing and want early access to Gemz' fastest
									...
									<div className="pt-4 border-t border-white/10">
										<p className="text-white/60 text-xs">
											🕒 Once-in-a-lifetime pricing for the first 50 brands only.
										</p>
									</div>
								</div>
							</div>
						...
						<div className="space-y-6">
							...
							>
								<p className="text-3xl lg:text-4xl text-white/70 leading-relaxed text-balance">
									...
									<span className="italic">real-time</span> search and AI learning to instantly
									surface influencers who actually perform for your brand, your niche, and{' '}
				...
				<div className="max-w-7xl mx-auto">
					...
					<div className="text-center mb-16 space-y-4">
						...
						<p className="text-white/70 text-lg">
							Everything you need to automate influencer operations and boost ROI
						</p>
					</div>
							...
							<div className="space-y-6">
								<div className="space-y-4">
									<div className="space-y-3">
										<div className="p-4 bg-black/40 rounded-lg border border-white/10">
											...
											<p className="text-white/60 text-xs">
												Discover creators using keywords, hashtags, and phrases.
											</p>
										</div>
										<div className="p-4 bg-black/40 rounded-lg border border-white/10">
											<h4 className="text-white text-sm font-semibold mb-1">
								...
								<div className="space-y-2">
									...
									<p className="text-white/70">
										Enter a keyword or product. Get live results from across platforms.
									</p>
								</div>
							</div>
						</div>
						...
						<div className="rounded-lg border backdrop-blur-md bg-white/5 border-white/10 p-8 hover:bg-white/10 transition-all">
							<div className="space-y-6">
								...
								<div className="space-y-2">
									...
									<p className="text-white/70">
										Matches are ranked by relevance to your brand and audience, not by vanity
										metrics.
									</p>
								</div>
							</div>
							...
							<div className="space-y-6">
								...
								<div className="space-y-2">
									...
									<p className="text-white/70 text-sm">
										The more you search, the more Gemz knows who works for you.
									</p>
								</div>
							</div>
						</div>
							...
							<>
								...
								<div className="space-y-6">
									...
									<p className="text-white/70 text-lg leading-relaxed">
										Search through keywords or discover similar creators across TikTok, Instagram,
										and YouTube. Our AI-powered discovery instantly surfaces influencers who match
										your brand and campaign goals.
									</p>
								</div>
							</>
						)}
							...
							<>
								...
								<div className="space-y-6">
									...
									<h3 className="text-4xl font-bold text-white">
										Discover High Performing Influencers
									</h3>
									<p className="text-white/70 text-lg leading-relaxed">
										Search by keyword, niche, or brand name and instantly uncover creators who match
										your campaign goals. Our AI analyzes performance metrics like engagement, views,
										and audience fit, delivering results you can act on fast.
									</p>
								</div>
							</>
						)}
						...
						{activeStep === 3 && (
							<>
								...
								<div className="space-y-6">
									...
									<p className="text-white/70 text-lg leading-relaxed">
										Create curated lists of your perfect influencer matches: Export complete
										profiles with bio, email, engagement metrics, and social links in one click.
										Take your data anywhere: CRM, email tools, or spreadsheets, and launch campaigns
										instantly.
									</p>
								</div>
							</>
					...
					<div className="grid lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
						...
						<div className="bg-black border border-zinc-800 rounded-3xl p-8">
							<div className="space-y-6">
								...
								<div className="space-y-3">
									...
									<div className="flex items-center space-x-3">
										<Check className="h-4 w-4 text-zinc-500" />
										<span className="text-zinc-400 text-sm">6,000 creators/month</span>
									</div>
									<div className="flex items-center space-x-3">
										<Check className="h-4 w-4 text-zinc-500" />
									...
									<div className="flex items-center space-x-3">
										<Check className="h-4 w-4 text-zinc-500" />
										<span className="text-zinc-400 text-sm">Basic analytics</span>
									</div>
								</div>
							</div>
						</div>
						...
						<div className="bg-black border-2 border-pink-500 rounded-3xl p-8 relative">
							<div className="absolute top-6 right-6">
								<div className="px-3 py-1.5 rounded-full bg-zinc-800 text-white text-xs font-medium">
									Most Popular
								</div>
							</div>
							...
							<div className="space-y-6">
								...
								<div className="space-y-3">
									...
									<div className="flex items-center space-x-3">
										<Check className="h-4 w-4 text-zinc-500" />
										<span className="text-zinc-400 text-sm">30,000 creators/month</span>
									</div>
									<div className="flex items-center space-x-3">
										<Check className="h-4 w-4 text-zinc-500" />
						...
						<div className="bg-black border border-zinc-800 rounded-3xl p-8 relative">
							<div className="space-y-6">
								...
								<div className="space-y-3">
									...
									<div className="flex items-center space-x-3">
										<Check className="h-4 w-4 text-zinc-500" />
										<span className="text-zinc-400 text-sm">75,000 creators/month</span>
									</div>
									<div className="flex items-center space-x-3">
										<Check className="h-4 w-4 text-zinc-500" />
										<span className="text-zinc-400 text-sm">API access</span>
