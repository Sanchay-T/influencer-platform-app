...
import { AlertCircle, ArrowRight, Lightbulb, Sparkles, Target } from 'lucide-react';
					...
					<CardContent>
										...
										onBlur={() => {
											logUserAction(
												'form_field_blur',
												{
													...
													descriptionPreview:
														brandDescription.trim().substring(0, 100) +
														(brandDescription.length > 100 ? '...' : ''),
												},
												{
													userId,
													userEmail: user?.primaryEmailAddress?.emailAddress,
						...
						<div className="mt-6 p-4 bg-zinc-800/60 border border-zinc-700/50 rounded-lg">
							<p className="text-xs text-zinc-300">
								<strong>Privacy note:</strong> This information helps us personalize your search
								results. It's never shared with third parties and you can update it anytime in your
								settings.
							</p>
						</div>
					</CardContent>
