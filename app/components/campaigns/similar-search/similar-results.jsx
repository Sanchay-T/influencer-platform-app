					...
					<Table className="w-full">
						<TableHeader>
							<TableRow className="border-b border-zinc-800">
								...
								<TableHead className="hidden xl:table-cell px-4 py-3 text-right text-xs font-medium uppercase tracking-wider text-zinc-400">
									Engagement
								</TableHead>
								<TableHead className="hidden lg:table-cell px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-zinc-400">
									Location
						...
						<TableBody className="divide-y divide-zinc-800">
							{getCurrentPageData().map((creator) => (
								<TableRow key={creator.username} className="table-row align-top">
									...
									<TableCell className="hidden md:table-cell px-4 py-4 text-right text-sm text-zinc-300">
										{creator.followers}
									</TableCell>
									<TableCell className="hidden xl:table-cell px-4 py-4 text-right text-sm text-zinc-300">
										{creator.engagement}
									</TableCell>
