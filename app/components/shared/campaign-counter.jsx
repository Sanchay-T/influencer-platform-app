 ...
 */
export default function CampaignCounter({ 
  variant = 'pill', 
  className = '', 
  showLabel = true 
}) {
  ...
  if (isLoading || !usageData) {
    return (
      <div className={`animate-pulse bg-gray-200 rounded-lg h-6 w-24 ${className}`}></div>
    );
  }

  const renderPillVariant = () => (
    <div className={`flex items-center gap-2 px-3 py-1.5 bg-gray-50 border border-gray-200 rounded-lg ${className}`}>
