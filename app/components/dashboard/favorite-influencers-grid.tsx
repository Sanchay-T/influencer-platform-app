...
import { Instagram, Music2, Star, User, Youtube } from 'lucide-react';
...
function PlatformBadge({ platform }: { platform: string }) {
	...
	return (
		<span
			className={cn(
				'inline-flex items-center gap-1 text-xs font-medium text-zinc-400 min-w-0',
				config.accent
			)}
		>
	...
	return (
		<Card
			className={cn(
				...
				canNavigate &&
					'cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-400/60'
			)}
...
export function FavoriteInfluencersGrid({
	influencers,
	emptyMessage = 'No favorite creators saved yet. Star a list to pin its creators here.',
}: FavoriteInfluencersGridProps) {
