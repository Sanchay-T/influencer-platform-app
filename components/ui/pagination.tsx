...
type PaginationNavProps = React.ComponentPropsWithoutRef<'a'>;

const PaginationPrevious = ({ className, ...props }: PaginationNavProps) => (
	<PaginationLink
...
const PaginationNext = ({ className, ...props }: PaginationNavProps) => (
	<PaginationLink
