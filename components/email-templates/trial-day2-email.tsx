    ...
    <Body style={main}>
      ...
      <Container style={container}>
        ...
        <Text style={paragraph}>
          ...
          influencers for{businessName ? ` ${businessName}` : ' your brand'}. Here are some 
          pro tips to get the most out of your experience:
        </Text>

        <Section style={tipSection}>
          <Text style={tipTitle}>🎯 <strong>Pro Tips for Better Results:</strong></Text>
          
          <Text style={tipItem}>
            <strong>1. Use specific keywords:</strong> Instead of "fitness", try "home workouts" 
            or "yoga for beginners" for more targeted results.
          </Text>
        ...
        <Section style={statsSection}>
          <Text style={statsTitle}>📊 <strong>Average Trial Results:</strong></Text>
        ...
        <Section style={helpSection}>
          ...
          <Text style={paragraph}>
            Our team can show you advanced search techniques and help optimize your campaigns. 
            Just reply to this email to schedule a quick 15-minute call!
          </Text>
        </Section>
