	...
	<Html>
		...
		<Body style={main}>
			...
			<Container style={container}>
				...
				<Text style={title}>Amazing progress! Your trial ends in 2 days 🏆</Text>
				...
				<Text style={paragraph}>
					...
					{businessName ? ` ${businessName}` : ' you'} has accomplished! Your trial ends in just 2
					days, so let's make sure you don't lose access to this powerful platform.
				</Text>

				<Section style={accomplishmentSection}>
					<Text style={accomplishmentTitle}>
						🎉 <strong>Look what you've achieved:</strong>
					</Text>
				...
				<Section style={urgencySection}>
					...
					<Text style={paragraph}>
						Your trial expires in <strong>2 days</strong>. Continue your influencer marketing
						journey with full access to:
					</Text>
				...
				<Section style={buttonSection}>
					...
					<Text style={buttonSubtext}>Only $49/month • Cancel anytime • No setup fees</Text>
				</Section>

				<Section style={socialProofSection}>
					<Text style={socialProofTitle}>
						🌟 <strong>Join 2,500+ brands that trust us:</strong>
					</Text>
					...
					<Text style={testimonialAuthor}>— Maria S., Growth Marketing Lead</Text>
				</Section>

				<Text style={paragraph}>
					<strong>Questions about upgrading?</strong> Our team is here to help! Reply to this email
					or{' '}
				...
				<Section style={reminderSection}>
					<Text style={reminderText}>
						🔔 <strong>Reminder:</strong> Your trial ends on [TRIAL_END_DATE]. Upgrade before then
						to maintain uninterrupted access to your campaigns and data.
					</Text>
				</Section>
