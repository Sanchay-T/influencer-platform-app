		...
		<Card className="border-purple-200 bg-purple-50">
			...
			<CardContent className="space-y-6">
				...
				<div className="space-y-4">
					<div>
						<Label htmlFor="email-type" className="text-purple-800">
							Email Type
						</Label>
					...
					<div>
						<Label htmlFor="delay" className="text-purple-800">
				...
				<div className="bg-purple-100 rounded-lg p-4 space-y-2">
					...
					<p className="text-xs text-purple-700 italic mt-2">
						💡 Tip: Use short delays (30s-2m) for quick testing. Emails are sent via Resend +
						QStash.
					</p>
				</div>
			</CardContent>
