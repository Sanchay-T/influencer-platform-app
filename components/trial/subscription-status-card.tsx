    ...
    switch (currentPlan) {
      ...
      case 'premium':
        return {
          ...
          features: ['Unlimited searches', 'Advanced bio extraction', 'Priority support', 'Analytics']
        };
      case 'enterprise':
        return {
      ...
      <CardContent className="space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-gray-600">
            Billing monthly • All features unlocked
          </p>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-green-700 text-sm mt-1">
                You have full access to all {planDetails.name.toLowerCase()} features. 
