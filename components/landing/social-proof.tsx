	...
	const testimonials = [
		{
			...
			content:
				'Found 500+ fashion influencers in 2 hours. The bio extraction saved us weeks of manual research.',
		...
		},
		{
			...
			content:
				'The email extraction feature is game-changing. We went from 5% to 40% influencer response rate.',
		...
		},
		{
			...
			content:
				'Multi-platform search across TikTok, Instagram, and YouTube in one place. Absolute time-saver.',
		...
		<div className="max-w-6xl mx-auto px-4 py-12">
			<div className="text-center mb-12">
				...
				<p className="text-gray-600">
					See how companies discover and connect with influencers faster
				</p>
			</div>
