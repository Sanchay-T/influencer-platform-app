...
export class OnboardingLogger {
	...
	public static async log(entry: Omit<OnboardingLogEntry, 'timestamp'>): Promise<void> {
		const timestamp = OnboardingLogger.getTimestamp();
		const logEntry: OnboardingLogEntry = { timestamp, ...entry };
		const logLine = OnboardingLogger.formatLogLine(logEntry);
	...
	// Navigation
	public static async logNavigation(
		action: string,
		description: string,
		userId?: string,
		data?: unknown,
	...
	// Stripe/Payment
	public static async logPayment(
		action: string,
		description: string,
		userId?: string,
		data?: unknown,
	 ...
	 */
	public static async logModalEvent(
