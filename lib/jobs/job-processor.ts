    ...
    try {
      ...
      switch (job.jobType) {
        case 'complete_onboarding':
          result = await this.processCompleteOnboarding(job.payload);
          break;
          
        case 'send_trial_email':
          result = await this.processSendTrialEmail(job.payload);
          break;
          
        case 'expire_trial':
          result = await this.processExpireTrial(job.payload);
          break;
