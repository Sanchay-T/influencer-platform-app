...
import { discoverySearchSimilar, type DiscoveryAccount } from '@/lib/services/influencers-club';
...
export async function runSimilarDiscoveryProvider(
  ...
  const targetPlatform = (platformSuffix === 'tiktok' ? 'tiktok' : 'instagram') as 'instagram' | 'tiktok';
  ...
  let allCreatorsThisRun: NormalizedCreator[] = [];
