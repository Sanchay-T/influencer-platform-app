...
export async function POST(req: Request) {
  console.log('🚀 INICIO DE SOLICITUD POST A /api/scraping/instagram');
  try {
    ...
    console.log('🔍 Leyendo cuerpo de la solicitud');
    // Leer el cuerpo de la solicitud
    const bodyText = await req.text();
    console.log('📝 Longitud del cuerpo de la solicitud:', bodyText.length);
    
    console.log('🔍 Parseando JSON del cuerpo');
    ...
    console.log('🔍 Extrayendo datos del cuerpo');
